/*
  demo_queries_.sql
  CSCI-331 Project 2.5 | Kanwal Jit Singh

  Presentation demo queries (Option 2).
  Aligned to:
    - Professor handouts in Project_specifications (UDTs, CHECK constraints, schemas)
    - Our team implementation (UserDefinedTypes, Normalized, Subroutines, Process)

  ADDITIVE: does not replace message.txt.
  Run in SSMS against database PrestigeCars (restore ClassTimeEOSgrp2PrestigeCars.bak first).

  Demo order for class (about 3-5 minutes): run steps 1 through 6 in order.
*/
...
/* ============================================================================
   STEP 1 — User-defined types (UDT)
   Class topic: reusable datatypes for application columns (Project 2.5 requirement)
...
/* ============================================================================
   STEP 2 — UDTs on a real table (INFORMATION_SCHEMA)
...
/* ============================================================================
   STEP 3 — CHECK constraints (professor: Creating Constraints handout)
...
/* ============================================================================
   STEP 5 — Views (replace yellow-highlighted physical tables)
...
/* ============================================================================
   OPTIONAL — Row counts on normalized tables (verification)
