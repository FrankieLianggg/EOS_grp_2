...
public class Product {
    ...
    public Product(int productId, String productName, int supplierId, int categoryId, String quantityPerUnit, BigDecimal unitPrice, int unitsInStock, int unitsOnOrder, int reorderLevel, boolean discontinued) {
